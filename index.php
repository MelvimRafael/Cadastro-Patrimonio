        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">Patrimonio de corrente</h1>
                    <p class="lead text-muted">Seja muito bem vindo ao nosso site</p>
                    <!-- <p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h6> Data de Origem: <?php echo $value->data_origem; ?></h6>
                                <h6> Data Cadastro: <?php echo $value->data_cadastro; ?></h6>
                                <br>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"><a
                                                href="<?php echo $value->googlemaps; ?>" target="_blank"
                                                rel="noopener noreferrer"> Google Maps</a></button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"><a
                                                href="<?php echo $value->url_video; ?>" target="_blank"
